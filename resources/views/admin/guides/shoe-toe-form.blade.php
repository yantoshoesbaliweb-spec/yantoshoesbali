      ...
      <div class="col-12 col-lg-8">
        <div class="card p-3 p-md-4">
          ...
          <div class="mb-3">
            ...
            <textarea class="form-control @error('description') is-invalid @enderror" name="description" rows="4" placeholder="Description of the silhouette and toe profile...">{{ old('description', $shoeToe->description ?? '') }}</textarea>
            @error('description')
              <div class="invalid-feedback">{{ $message }}</div>
            @enderror
          </div>
